...
webbrowser.open_new("http://twitter-timeline-app.appspot.com/app/_completitudLatency.html")
#webbrowser.open_new("http://twitter-timeline-app.appspot.com/app/_completitudAccuracy.html")
