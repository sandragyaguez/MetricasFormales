...
class OauthTwitter():
  ...
  def __init__(self, consumer_key, consumer_secret, access_key, access_secret):
    ...
    self.request_access_token= "https://api.twitter.com/oauth/access_token"
    self.authenticate_url = "https://api.twitter.com/oauth/authenticate"
    self.request_tweets= "https://api.twitter.com/1.1/search/tweets.json"
    self.request_usertimeline="https://api.twitter.com/1.1/statuses/user_timeline.json"
    self.credentials="https://api.twitter.com/1.1/account/verify_credentials.json"
...
##Encontrar el texto del tweet que acabo de publicar, con el campo text que tiene cada tweet, y timestamp cuando me lo muestre en twitter (tambien se puede hacer con ID)(polling)
    for tweet in timeline:
       ...
       #me devuelve una hora menos!!!!!!!!!! (no influye en tiempo final del script pero cuidado con este campo) TENGO QUE COMPARAR CON ESTE TIEMPO!!!!!MIGUEL
        #print tweet['created_at']
        #print "el id del tweet es: " + str(tweet['id_str'])
        if text==estado:
            break
...
#     dif=tiguales-tpubl
#     print "dif en formato entero es: " + str(dif)
...
#     print "diferencia tiempos en ms: "  + str(dif_ms)
